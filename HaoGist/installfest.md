...
4.	__Install git__
  * **Note**: Git may be installed with command line tools, so check before you do this step. `git -v`
...
6.	__Install RBENV with the latest ruby
	* brew install rbenv
	* brew install ruby-build
	* rbenv install --list (2.2.2 is the latest as of this writing)
	* rbenv install 2.2.2
	* Run: `echo 'if which rbenv > /dev/null; then eval "$(rbenv init -)"; fi' >> ~/.bash_profile; source ~/.bash_profile`
	* rbenv global 2.2.2
	* ruby --version (should print 2.2.2)
	* WOOT RUBY WHAT WHATTTTT
...
4. __Install RBENV__
  * Probably easiest to install it via git to be honest
  * 
##Windows Users
...
2. __Download Ubuntu Linux__
  ...
  * Version 14.04 is probably preferable
...
Setup the CLI shortcut on mac: https://www.sublimetext.com/docs/3/osx_command_line.html